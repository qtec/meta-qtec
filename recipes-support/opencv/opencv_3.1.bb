...
DEPENDS = "python3-numpy libtool swig swig-native python3 bzip2 zlib glib-2.0 libwebp protobuf protobuf-native gflags lapack glog"
...
EXTRA_OECMAKE = "-DPYTHON3_NUMPY_INCLUDE_DIRS:PATH=${STAGING_LIBDIR}/${PYTHON_DIR}/site-packages/numpy/core/include \
...
PACKAGECONFIG_append_qt5022-fglrx ??= "amdblas amdfft"
...
inherit distutils3-base pkgconfig cmake
...
PACKAGES += "${@bb.utils.contains('PACKAGECONFIG', 'java', '${PN}-java-dbg ${PN}-java', '', d)} \
	     ${PN}-samples-dbg ${PN}-samples ${PN}-apps python3-opencv"
