...
do_install_append(){
	mv ${D}/usr/include/pygobject-3.0/pygobject.h ${D}/usr/include/python3-pygobject.h
	mv ${D}/usr/lib/pkgconfig/pygobject-3.0.pc ${D}/usr/lib/pkgconfig/python3-pygobject-3.0.pc
}
